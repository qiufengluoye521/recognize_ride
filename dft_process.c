...
#define F_PATH "C:\\design\\C\\C_free\\recognize_ride\\c_result.txt"  
...
static fft_out_ride_process_cb_t fft_out_ride_process_cb 	= NULL;


void fft_out_process_reg(fft_out_process_cb_t fun1,fft_out_ride_process_cb_t fun2)
{
	fft_out_process_cb 		= fun1;
	fft_out_ride_process_cb = fun2;
}
...
//		fft_out_process_cb(alg_data->hrm_fft_out_vector,alg_data->gsen_fft_out_vector); 
		fft_out_ride_process_cb(alg_data->hrm_fft_out_vector); 
